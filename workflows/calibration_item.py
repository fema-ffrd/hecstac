...
def create_calibration_item(ras_project_path, output_prefix):
    bucket, prefix, ras_model_name = parse_ras_project_path(ras_project_path)

    output_item_path = f"{output_prefix}/model={ras_model_name}/item.json"
...
if __name__ == "__main__":
    ras_project_path = "s3://trinity-pilot/calibration/hydraulics/blw-elkhart/blw-elkhart.prj"
    output_prefix = "s3://trinity-pilot/stac/prod-support/calibration"
    create_calibration_item(ras_project_path, output_prefix)
