...
class RasModelItem(Item):
    def __init__(self, prj_file: str, href: str = "", simplify_tolerance: float | None = 0.01):
        id = ""
        geometry = NULL_STAC_GEOMETRY
        bbox = NULL_STAC_BBOX
        item_datetime = NULL_DATETIME
        start_datetime = None
        end_datetime = None
        properties = {}
        ...
        self._geom_files: list[GeometryAsset | GeomHdfAsset] = []
        self._linkable_files: list[ProjectAsset | PlanAsset | PlanHdfAsset | GeomHdfAsset] = []
        self._has_1d = False
        self._has_2d = False
        ...
        if self._geometry == NULL_STAC_GEOMETRY:
            ...
            if self.has_2d:
                ...
                for geom_asset in self.geometry_files:
                    if isinstance(geom_asset, GeomHdfAsset):
